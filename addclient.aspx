...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    &nbsp;
    <div style="z-index: 101; left: 69px; width: 383px; position: absolute; top: 5px; height: 197px">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table border="0" style="width: 374px">
                    <tr>
                        <td colspan="2" style="font-size: 12px; color: black; border-top-style: none; border-right-style: none; border-left-style: none; background-color: #7ec3bf; text-align: center; border-bottom-style: none">
                            <span>添加顾客信息</span></td>
                    </tr>
                    <tr>
                        <td style="width: 117px; height: 15px">顾客姓名：</td>
    ...
    <div style="z-index: 102; left: 499px; width: 100px; position: absolute; top: 246px; height: 24px">
